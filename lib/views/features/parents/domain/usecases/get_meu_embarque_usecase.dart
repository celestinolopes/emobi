...
class GetMeuEmbarqueMotoristaUseCase extends UseCase<bool, int> {
  final IParentRepository? iParentRepository;
  GetMeuEmbarqueMotoristaUseCase({required this.iParentRepository});
  @override
  Future<Either<Failure, bool>> call(int? params) async {
    final result =
        await iParentRepository!.getMeuEmbarqueMotorista(idMotorista: params);
    return result;
  }
}
